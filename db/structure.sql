...
CREATE TABLE "entities" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(255), "total_damage" integer, "player" boolean, "total_healing" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "combat_log_id" integer);
