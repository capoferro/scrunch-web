...
CREATE TABLE "encounters" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "combat_log_id" integer, "start_time" datetime, "end_time" datetime, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
